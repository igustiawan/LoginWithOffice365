...
namespace Loginwithoffice365.Controllers
{
    [Authorize]
    public class UserProfileController : Controller
    {
        ...
        private string aadInstance2 = EnsureTrailingSlash(ConfigurationManager.AppSettings["ida:AADInstance2"]);
        ...
        public async Task<ActionResult> Index()
        {
            ...
            try
            {
                ...
                var result2 = await activeDirectoryClient.Users
                    .Where(u => u.ObjectId.Equals(userObjectID))
                    .ExecuteAsync();

                //IUser user = result.CurrentPage.ToList().First();
                //IUser user = result.Context.
        ...
        public async Task<string> GetTokenForApplication()
        {
            ...
            AuthenticationContext authenticationContext = new AuthenticationContext(aadInstance, new ADALTokenCache(signedInUserID));
